...
class AppTheme {
  ...
  static const LinearGradient ternaryGradient = LinearGradient(
    colors: [
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleLarge:
          poppins(fontWeight: FontWeight.w500, fontSize: 30, color: textColor),
      titleMedium:
          poppins(fontWeight: FontWeight.w500, fontSize: 20, color: textColor),
      bodyLarge: poppins(
